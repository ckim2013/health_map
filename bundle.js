...
const orangeFrequencyLegendLabels = ["No data", "0.00 - 0.04", "0.50 - 0.99", "1.00 - 4.99", "5.00 - 9.99", "10.00 - 49.99", ">= 50.00"];
const greenMoneyLegendLabels = ["No data", "0 - 49", "50 - 99", "100 - 499", "500 - 999", "1000 - 2999", ">= 3000"];

const redDeathColor = ["#edeced", "#ffcccc", "#ff9999", "#ff6666", "#ff3232", "#ff0000", "#7f0000"];
const redDeathDomain = [0, 500, 5000, 10000, 50000, 100000];

const blueDeathColor = ["#edeced", "#ccccff", "#9999ff", "#6666ff", "#3232ff", "#0000ff", "#00007f"];
const blueDeathDomain = [0, 100, 5000, 10000, 30000, 100000];

const orangeFrequencyColor = ["#edeced", "#ffe4b2", "#ffd27f", "#ffc04c", "#ffae19", "#e59400", "#996300"];
const orangeFrequencyDomain = [0, 0.05, 1, 5, 10, 50];
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return __WEBPACK_IMPORTED_MODULE_2__src_json__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_8__src_threshold__["a"]; });
